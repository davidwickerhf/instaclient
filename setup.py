...
setup(
  ...
  version = '2.9.15',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/davidwickerhf/instaclient/archive/v2.9.15.tar.gz',    # I explain this later on
