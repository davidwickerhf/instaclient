...
setup(
  ...
  version = '1.9.21',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/wickerdevs/py-instaclient/archive/v1.9.21.tar.gz',    # I explain this later on
